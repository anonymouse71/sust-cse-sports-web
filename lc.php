...
<!-- End of style sheet -->
 ...
 <button type="button" class="btn btn-success btn-lg btn-block">
     <h2>SUST CSE Cricket Tournament 2014 Results</h2>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <!-- <h1 style="font-size:40px"  id="navbar" align=center >SUST CSE Cricket Tournament 2014 Results:</h1> -->
		      ...
		      <b>Champion:</b> CSE 2012 Batch </b>
              </div>
              
              <div class="well well-sm col-md-5 col-md-offset-3" align=center style="font-size:18px">
		      <b>Runner-Up:</b> CSE 2013 Batch 
             </div>
			 <div class="well well-sm col-md-5 col-md-offset-4" align=center style="font-size:18px">
		        <b>Man of the Final:</b> Ashraful Sujan(2013 Batch) 
              </div>
			  
			  <div class="well well-sm col-md-5 col-md-offset-3" align=center style="font-size:18px">
		       <b>Best Allrounder:</b> xyz
             </div>
			 <div class="well well-sm col-md-5 col-md-offset-4" align=center style="font-size:18px">
		       <b>Best Bowler: </b>CSE 2013 Batch 
              </div>
			   <div class="well well-sm col-md-5 col-md-offset-3" align=center style="font-size:18px">
		     <b>  Best Batsman:</b> CSE 2013 Batch 
              </div>
